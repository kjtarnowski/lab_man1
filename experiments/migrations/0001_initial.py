    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experimental_set', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiments_of_this_set', to='experiments.ExperimentalSet')),
                ('exptype', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experiments_of_this_type', to='experiments.ExperimentType')),
                ('lab_person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='experiments_of_person', to='experiments.LabPerson')),
            ],
        ),
        migrations.AddField(
            model_name='compound',

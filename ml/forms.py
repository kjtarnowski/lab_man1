...
class MLAlgorithmForm(forms.ModelForm):
    class Meta:
        ...
        labels = {
            "joblib_binary_file_algorithm": "Upload joblib file - algorithm",
            "joblib_binary_file_encoders": "Upload joblib file - encoders",
        }
        widgets = {"joblib_binary_file_algorithm": forms.FileInput(), "joblib_binary_file_encoders": forms.FileInput()}
